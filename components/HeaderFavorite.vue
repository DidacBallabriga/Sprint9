      ...
      <b-navbar-toggle target="collapse-area"></b-navbar-toggle>
        <b-collapse id="collapse-area" is-nav>
          ...
          <div class="buttons" v-if="this.$store.loggedIn===false">
            ...
            <NuxtLink to="/instructions"><button class="my-button button-custom-intructions">INSTRUCTIONS</button></NuxtLink>
      <button @click="exportCSVFile(songs, favoritelist)" class="my-button button-custom-download">DOWNLOAD</button>
...
.button-custom-download:hover{ 
     color: #5DC1B9;
}
.button-custom-intructions{ 
    margin-right: 1rem;
    color:rgb(143, 140, 140);
    width: 135px;
    height: 50px;
